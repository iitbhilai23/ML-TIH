...
import { Lock, User, ArrowRight, TrendingUp, Eye, EyeOff, Sparkles } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className={styles.pageContainer}>
      {/* 3. Add Toaster component (Sonner handles CSS automatically) */}
      ...
      <div className={styles.brandSide}>
        <div className={styles.brandingContent}>
          ...
          <div className={styles.imageSection}>
            <div className={styles.imageDecorations}></div>
